...
1. Sample size not less than 50 for a 2x2 contingency table - by using chi squared test on small samples, might end up committing a [Type II error](https://en.wikipedia.org/wiki/Type_I_and_type_II_errors#Type_II_error)
2. Expected cell count should be 5 or more for 80% of the cells
