...
boxplot(students$G3_mat[students$Medu=="0"], students$G3_mat[students$Medu=="1"], students$G3_mat[students$Medu=="2"], students$G3_mat[students$Medu=="3"], students$G3_mat[students$Medu=="4"], students$G3_mat[students$Fedu=="0"], students$G3_mat[students$Fedu=="1"], students$G3_mat[students$Fedu=="2"], students$G3_mat[students$Fedu=="3"], students$G3_mat[students$Fedu=="4"], names = c("M/0", "M/1", "M/2", "M/3", "M/4", "F/0", "F/1", "F/2", "F/3", "F/4"),xlab="Mother/Father education",ylab="Mat final grade")

boxplot(students$G3_por[students$Medu=="0"], students$G3_por[students$Medu=="1"], students$G3_por[students$Medu=="2"], students$G3_por[students$Medu=="3"], students$G3_por[students$Medu=="4"], students$G3_por[students$Fedu=="0"], students$G3_por[students$Fedu=="1"], students$G3_por[students$Fedu=="2"], students$G3_por[students$Fedu=="3"], students$G3_por[students$Fedu=="4"], names = c("M/0", "M/1", "M/2", "M/3", "M/4", "F/0", "F/1", "F/2", "F/3", "F/4"),xlab="Mother/Father education",ylab="Por final grade")

boxplot(students$G3_mat[students$highestparentedu=="0"], students$G3_mat[students$highestparentedu=="1"], students$G3_mat[students$highestparentedu=="2"], students$G3_mat[students$highestparentedu=="3"], students$G3_mat[students$highestparentedu=="4"], names = c("none", "primary", "5th to 9th grade", "secondary", "higher"),xlab="Highest parent education",ylab="Mat final grade")

boxplot(students$G3_por[students$highestparentedu=="0"], students$G3_por[students$highestparentedu=="1"], students$G3_por[students$highestparentedu=="2"], students$G3_por[students$highestparentedu=="3"], students$G3_por[students$highestparentedu=="4"], names = c("none", "primary", "5th to 9th grade", "secondary", "higher"),xlab="Highest parent education",ylab="Por final grade")
...
#radi pojave frekvencije manje od 5 koristimo Fisherov test
fisher.test(tbl, simulate.p.value = TRUE, B = 1e7)
```
chisq.test je nepouzdan pošto su očekivane frekvencije pojedinih  razreda manje od 5, radi toga koristimo fisher.test. p-value testa iznosi manje od 0.05 stoga odbacujemo hipotezu H0, te zaključujemo da su edukacija više educiranog roditelja i završna ocjena iz matematike zavisne.
...
tbl2 = table(students$highestparentedu, students$Por_grade)
print(addmargins(tbl2))
chisq.test(tbl2,correct=F)
#radi pojave frekvencije manje od 5 koristimo Fisherov test
fisher.test(tbl2, simulate.p.value = TRUE, B = 1e7)
```

chisq.test je nepouzdan pošto su očekivane frekvencije pojedinih  razreda manje od 5, radi toga koristimo fisher.test. p-value testa iznosi manje od 0.05 stoga odbacujemo hipotezu H0, te zaključujemo da su edukacija više educiranog roditelja i završna ocjena iz portigala zavisne.
...
#izbacujemo slučajeve kada je edukacija majke 0 zato što imamo premalo takvih slučajeva
studentscopy = students %>% filter(students$Medu != "0")
tbl2 = table(studentscopy$Medu, studentscopy$Mat_grade)
...
#izbacujemo slučajeve kada je edukacija majke 0 zato što imamo premalo takvih slučajeva
studentscopy = students %>% filter(students$Medu != "0")
tbl2 = table(studentscopy$Medu, studentscopy$Por_grade)
...
chisq.test je nepouzdan pošto su očekivane frekvencije pojedinih  razreda manje od 5, radi toga koristimo fisher.test. p-value Testa nezavisnosti iznosi manje od 0.05 stoga odbacujemo hipotezu H0, te zaključujemo da su edukacija majke i završna ocjena iz portugala zavisne.
