...
tbl = table(data1$highestparentedu, data1$G3_mat)
print(addmargins(tbl))
print(tbl)
chisq.test(tbl,correct=F)

c1 = data1 %>% filter(G3_mat <= 5 & highestparentedu=="1")
c2 = data1 %>% filter(G3_mat > 5 & G3_mat <= 10 & highestparentedu=="1")
c3 = data1 %>% filter(G3_mat > 10 & G3_mat <= 15 & highestparentedu=="1")
c4 = data1 %>% filter(G3_mat > 15 & G3_mat <= 20 & highestparentedu=="1")
c5 = data1 %>% filter(G3_mat <= 5 & highestparentedu=="4")
c6 = data1 %>% filter(G3_mat > 5 & G3_mat <= 10 & highestparentedu=="4")
c7 = data1 %>% filter(G3_mat > 10 & G3_mat <= 15 & highestparentedu=="4")
c8 = data1 %>% filter(G3_mat > 15 & G3_mat <= 20 & highestparentedu=="4")
tbl2 <- matrix(c(nrow(c1), nrow(c2), nrow(c3), nrow(c4), nrow(c5), nrow(c6), nrow(c7), nrow(c8)), ncol = 4, byrow=TRUE)
colnames(tbl2) <- c('0-5', '6-10', '11-15', '16-20')
